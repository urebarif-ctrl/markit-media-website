    ...
    >
      <div className="max-w-4xl mx-auto bg-black text-white p-6 sm:p-8 flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-8 shadow-2xl">
        ...
        <div className="flex gap-3 shrink-0">
          <button onClick={() => dismiss("accepted")} className="bg-white text-black px-6 py-3 min-h-[44px] text-base font-bold hover:bg-gray-100 transition-colors cursor-pointer focus-visible:outline-2 focus-visible:outline-white focus-visible:outline-offset-2">
            Accept
          </button>
          <button onClick={() => dismiss("dismissed")} className="border border-gray-600 text-gray-300 px-6 py-3 min-h-[44px] text-base font-medium hover:border-white hover:text-white transition-colors cursor-pointer focus-visible:outline-2 focus-visible:outline-white focus-visible:outline-offset-2">
            Dismiss
          </button>
        </div>
      </div>
