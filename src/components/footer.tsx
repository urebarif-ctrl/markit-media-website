  ...
  return (
    <div>
      ...
      <ul className="space-y-1">
        {links.map((link, i) => (
          <li key={`${link.label}-${i}`}>
            <Link href={link.href} className={`hover:text-white transition-colors block py-1.5 focus-visible:outline-2 focus-visible:outline-white focus-visible:outline-offset-2 ${i === 0 ? "text-base font-medium text-gray-300" : "text-base text-gray-400"}`}>
              {link.label}
            </Link>
          </li>
        ))}
      ...
      <section className="px-6 lg:px-12 py-20 text-center border-b border-white/10">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            ...
            <Link href="/work" className="inline-flex items-center gap-3 border-2 border-white text-white px-10 py-5 font-bold text-base hover:bg-white hover:text-black transition-colors">
              {t.cta.secondary}
            </Link>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div>
              ...
              <div className="flex items-center gap-4">
                <a href="https://www.linkedin.com/company/themarkitmedia" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors min-w-[44px] min-h-[44px] inline-flex items-center justify-center focus-visible:outline-2 focus-visible:outline-white focus-visible:outline-offset-2" aria-label="LinkedIn">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" /></svg>
                </a>
                <a href="https://www.instagram.com/themarkitmedia" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors min-w-[44px] min-h-[44px] inline-flex items-center justify-center focus-visible:outline-2 focus-visible:outline-white focus-visible:outline-offset-2" aria-label="Instagram">
      ...
      <div className="border-t border-white/10 px-6 lg:px-12 py-6">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <p className="text-base text-gray-500">
            <a href="mailto:ciao@themarkitmedia.com" className="hover:text-white transition-colors focus-visible:outline-2 focus-visible:outline-white focus-visible:outline-offset-2">ciao@themarkitmedia.com</a>
          </p>
        </div>
      </div>
    </footer>
