...
export default function ResultsPage() {
  ...
  return (
    <article>
      ...
      <section aria-label="Results" className="px-6 lg:px-12 pt-24 pb-16">
        ...
        <div className="max-w-3xl mx-auto">
          <Animate animation="fade-up">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Link href="/process" className="inline-flex items-center gap-3 border-2 border-white text-white px-10 py-5 font-bold text-base hover:bg-white hover:text-black transition-colors motion-reduce:transition-none focus-visible:outline-2 focus-visible:outline-white focus-visible:outline-offset-2">
                See Our Process
              </Link>
            </div>
          </Animate>
