...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Digital Marketing Glossary",
    description: "200+ marketing terms explained: SEO, PPC, social media, content marketing, analytics, and more.",
  },
};
...
const glossaryTerms = [
  ...
  { term: "Anchor Text", definition: "The clickable text in a hyperlink. Search engines use anchor text to understand the context and topic of the linked page." },
  ...
  { term: "Brand Equity", definition: "The commercial value derived from consumer perception of a brand name, beyond the value of the product or service itself." },
  { term: "Canonical URL", definition: "An HTML element that tells search engines which version of a URL is the primary page when duplicate or similar content exists across multiple URLs." },
  ...
  { term: "Dark Social", definition: "Social sharing that happens through private channels like messaging apps, email, and text messages that are not trackable by standard analytics tools." },
  { term: "Demand Generation", definition: "A marketing strategy focused on building awareness and interest in a product or service to create a pipeline of qualified leads over time." },
  { term: "E-E-A-T", definition: "Experience, Expertise, Authoritativeness, and Trustworthiness. Google's framework for evaluating content quality in search rankings." },
  { term: "Evergreen Content", definition: "Content that remains relevant and valuable over a long period, continuing to attract traffic and engagement without frequent updates." },
  ...
  { term: "Growth Hacking", definition: "A marketing approach focused on rapid experimentation across channels and product development to identify the most efficient ways to grow a business." },
  { term: "Heatmap", definition: "A visual representation of how users interact with a webpage, showing where they click, scroll, and spend the most time using color-coded overlays." },
  { term: "Inbound Marketing", definition: "A strategy that attracts customers by creating valuable content and experiences tailored to them, rather than pushing messages out through traditional advertising." },
  { term: "Intent Data", definition: "Information collected about user behavior that indicates their purchase intent, such as content consumption patterns, search queries, and engagement signals." },
  { term: "Lookalike Audience", definition: "An advertising targeting option that finds new potential customers who share similar characteristics with your existing customers or website visitors." },
  { term: "Marketing Automation", definition: "Technology that manages marketing processes and multifunctional campaigns across multiple channels automatically, including email, social media, and web." },
  { term: "Micro-Conversion", definition: "A small, measurable action that indicates a user is moving toward a primary conversion goal, such as signing up for a newsletter or adding an item to a cart." },
  { term: "Net Promoter Score (NPS)", definition: "A metric that measures customer loyalty by asking how likely they are to recommend your product or service on a scale of 0-10." },
  ...
  { term: "Page Speed", definition: "How quickly a web page loads its content. A critical ranking factor for SEO and a major influence on user experience and conversion rates." },
  ...
  { term: "Ad Fatigue", definition: "The decline in ad performance that occurs when the target audience sees the same advertisement too many times, leading to lower engagement and higher costs." },
  { term: "Audience Segmentation", definition: "The process of dividing a target market into distinct groups based on demographics, behavior, interests, or other criteria to deliver more relevant messaging." },
  { term: "Brand Equity", definition: "The commercial value derived from consumer perception of a brand name, built through positive experiences, quality, and marketing over time." },
  ...
  { term: "Content Syndication", definition: "The practice of republishing content on third-party platforms to reach a wider audience, often used for lead generation in B2B marketing." },
  ...
  { term: "Cross-Channel Marketing", definition: "A strategy that delivers a consistent brand experience across multiple marketing channels, ensuring seamless transitions between touchpoints." },
  { term: "Customer Acquisition Cost (CAC)", definition: "The total cost of acquiring a new customer, calculated by dividing total marketing and sales expenses by the number of new customers gained." },
  { term: "Data Clean Room", definition: "A secure environment where multiple parties can share and analyze data without exposing personally identifiable information, used for privacy-compliant audience targeting." },
  { term: "Demand Generation", definition: "A marketing strategy focused on creating awareness and interest in a company's products or services to build a pipeline of qualified leads." },
  { term: "Dynamic Creative Optimization (DCO)", definition: "Technology that automatically generates personalized ad variations based on user data, adjusting elements like images, copy, and CTAs in real time." },
  { term: "Engagement Rate", definition: "A metric that measures the level of interaction content receives from its audience, typically calculated as total engagements divided by impressions or reach." },
  { term: "First-Party Data", definition: "Data collected directly from your own audience through website analytics, CRM systems, email subscriptions, and customer interactions, considered the most valuable and privacy-compliant." },
  ...
  { term: "Heatmap", definition: "A visual representation of how users interact with a webpage, showing where they click, scroll, and hover, used to optimize page layout and UX." },
  { term: "Ideal Customer Profile (ICP)", definition: "A detailed description of the type of company or individual that would benefit most from your product or service, used to focus marketing and sales efforts." },
  { term: "Intent Data", definition: "Information about a prospect's online behavior that signals their interest in a product or service, such as content consumption, search queries, and website visits." },
  ...
  { term: "Lead Magnet", definition: "A free resource offered to prospects in exchange for their contact information, such as an ebook, template, calculator, or webinar." },
  ...
  { term: "Lookalike Audience", definition: "An advertising feature that targets people who share similar characteristics with your existing customers, used on platforms like Meta and Google to find new prospects." },
  { term: "Marketing Qualified Lead (MQL)", definition: "A lead that has been identified as more likely to become a customer based on their engagement with marketing content and fit with the ideal customer profile." },
  { term: "Micro-Conversion", definition: "A small action taken by a user that indicates progress toward a primary conversion goal, such as signing up for a newsletter, downloading a resource, or adding an item to a cart." },
  { term: "Multi-Touch Attribution", definition: "A model that assigns credit for a conversion to multiple marketing touchpoints along the customer journey, rather than just the first or last interaction." },
  { term: "Net Promoter Score (NPS)", definition: "A customer loyalty metric measured by asking how likely customers are to recommend a company on a scale of 0-10, resulting in a score from -100 to 100." },
  { term: "Omnichannel Marketing", definition: "A strategy that provides a seamless, integrated customer experience across all channels and devices, whether online, in-store, or through mobile." },
  { term: "Page Speed", definition: "How quickly a webpage loads its content, measured by metrics like Largest Contentful Paint (LCP) and Time to Interactive (TTI), affecting both UX and SEO rankings." },
  ...
  { term: "Programmatic Advertising", definition: "The automated buying and selling of digital ad space using algorithms and real-time bidding, allowing precise targeting at scale across multiple platforms." },
  ...
  { term: "Schema Markup", definition: "Structured data code added to a website that helps search engines understand the content better, often resulting in rich snippets and enhanced search results." },
  { term: "Search Intent", definition: "The underlying purpose behind a search query, categorized as informational, navigational, commercial, or transactional, used to align content with user needs." },
  { term: "Server-Side Tracking", definition: "A method of collecting analytics data on the server rather than the browser, providing more reliable tracking that is less affected by ad blockers and cookie restrictions." },
  { term: "Social Listening", definition: "The practice of monitoring social media channels for mentions of your brand, competitors, industry topics, and relevant keywords to gather insights and respond proactively." },
  { term: "Technical SEO", definition: "The optimization of website infrastructure and server settings to help search engines crawl, index, and render pages more effectively, including site speed, mobile-friendliness, and structured data." },
  ...
  { term: "Topic Cluster", definition: "A content strategy that organizes related content around a central pillar page, with cluster articles linking back to it, improving SEO authority for the overall topic." },
  ...
  { term: "Zero-Click Search", definition: "A search result where the answer is displayed directly on the search engine results page, so the user does not need to click through to a website." },
  { term: "Zero-Party Data", definition: "Data that a customer intentionally and proactively shares with a brand, such as preferences, purchase intentions, and personal context, typically through surveys, quizzes, or preference centers." },
  { term: "ROAS (Return on Ad Spend)", definition: "A metric that measures the revenue generated for every dollar spent on advertising, calculated by dividing revenue from ads by the cost of those ads." },
];
