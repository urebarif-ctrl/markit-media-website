    ...
    <main className="min-h-screen bg-white text-black">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          url: "https://themarkitmedia.com/en/resources/marketing-timeline-planner",
      ...
      <link rel="canonical" href="https://themarkitmedia.com/en/resources/marketing-timeline-planner" />
