...
export default function ContentBriefPage() {
  ...
  return (
    <article>
      ...
      {/* ---- Generated Brief ---- */}
      {brief && (
        <section aria-label="Content Brief:" className="px-6 lg:px-12 pb-12">
          <div className="max-w-3xl mx-auto">
            <Animate animation="fade-up">
      ...
      {/* ---- Tips Section ---- */}
      <section aria-label="Tips for Effective Content Briefs" className="px-6 lg:px-12 py-16 border-t border-gray-200">
        <div className="max-w-3xl mx-auto">
          <Animate animation="fade-up">
