      ...
      <section className="px-6 lg:px-12 py-20 bg-black text-white text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link href="/services/seo" className="inline-flex items-center gap-3 border-2 border-white text-white px-10 py-5 font-bold text-base hover:bg-white hover:text-black transition-colors">
              SEO Services
            </Link>
          </div>
        </div>
