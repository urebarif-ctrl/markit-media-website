      ...
      <section className="border-y border-gray-200 py-8 bg-white" aria-label="Platforms we manage">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="flex flex-wrap items-center justify-center gap-8 lg:gap-12">
            ...
            {/* X (Twitter) */}
            <svg className="h-6 text-gray-300 hover:text-black transition-colors" viewBox="0 0 24 24" fill="currentColor" aria-label="X"><path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932ZM17.61 20.644h2.039L6.486 3.24H4.298Z"/></svg>
            {/* Pinterest */}
            ...
            {getPublishedPosts(3).map((post) => (
              ...
              >
                <div className="aspect-[16/9] bg-gray-100 overflow-hidden">
                  {post.cover_image ? (
                    <img loading="lazy" src={post.cover_image} alt={post.title} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500 motion-reduce:transition-none" />
                  ) : (
